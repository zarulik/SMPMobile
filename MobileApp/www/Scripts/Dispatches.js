...
class DispatchesPage {
  ...
  InitializeDispatches() {
    ...
    smpMobileApi.GetCompanyInfo(
      ...
      function(error) {
        ...
        smpMobileApi.ShowModal(
          "Issue",
          "Issue during loading company info",
          "danger",
          5000
        );
      }
  ...
  InitializeDispatchEvents(dispatch, taskInfo, taskType, taskStatus, natureOfTask, dispatchDesc) {
    $("#" + dispatch.TaskNo + "_" + dispatch.DispatchNo).click(function() {
      SetCacheValue(
        CacheIds.selectedTaskDispatch,
        dispatch.TaskNo + "_" + dispatch.DispatchNo
      );
    ...
    if (taskInfo) {
      ...
      $("#" + dispatch.TaskNo + "_" + dispatch.DispatchNo + "_CustomerInfo").click(
          function(e)   {
            $("#CustNo").text("");
            $("#BillToName").text("");
            $("#BillToAddr").text("");
  ...
  CreateDispatchView(dispatch, dispatchStatus, dispatchDesc) {
    ...
    $dispatchView.append(
      '<p class="dispatchStatusBar"> Status: ' +
